...
class AirbnbAnalyzerApp:
    def __init__(self, root):
        ...
        self.default_db_path = 'your path goes here'
    ...
    def create_widgets(self):
        ...
        self.options = [
            ...
            "Kwerenda 1: Cena wedlug dzielnic (Renta Geograficzna)",
            "Kwerenda 2: Superhost",
            "Kwerenda 3: Typy pokoi",
            "Kwerenda 4: Okazje"
        ]
    ...
    def get_query_for_selection(self, selection):
        ...
        elif selection == "Kwerenda 1: Cena wedlug dzielnic (Renta Geograficzna)":
            return """
            SELECT 
                Dzielnica, 
        ...
        elif selection == "Kwerenda 2: Superhost":
            return """
            SELECT 
                Czy_Superhost, 
                COUNT(ID_oferty) AS Liczba_Ofert,
        ...
        elif selection == "Kwerenda 3: Typy pokoi":
            return """
            SELECT 
                Typ_pokoju,
                COUNT(ID_oferty) AS Liczba_Ofert,
        ...
        elif selection == "Kwerenda 4: Okazje":
            return """
            SELECT 
                Nazwa_oferty,
                Dzielnica,
